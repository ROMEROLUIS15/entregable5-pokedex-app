...
const Pokedex = () => {
 ...
 useEffect(() => {
  ...
  //? Trae todos los Pokemos con base a un tipo
  useEffect(() => {
    if (currentType !== "") {
      axios
...
// solucion bugs no muestra pagina al cambiar de tipo(reseteo de pagina actual al cambiar)
  useEffect(() => {
    setCurrentPage(1)
  }, [currentType])
